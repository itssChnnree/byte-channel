...
@Component(PaymentPeriodConstant.QUARTERLY)
public class QuarterlyOrderCreateStrategy implements OrderCreateStrategy{
    ...
    public BigDecimal calculatePrice(int num, Boolean havePromoCode, BigDecimal price) {
        ...
        total = price.multiply(new BigDecimal(num)).multiply(new BigDecimal("3"));
        //按季付款95折
